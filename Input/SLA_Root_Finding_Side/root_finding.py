...
def temp_fun(x):
    ...
    xmldata = xmldata.replace("**thickness**", str(x))
    xmldata = xmldata.replace("**firstcell**", str(x / 100))
...
if __name__ == "__main__":
    ...
    # Start optimization
    tc_goal, res = toms748(temp_fun, a=0.005, b=0.05, xtol=0.1e-3, full_output=True)
